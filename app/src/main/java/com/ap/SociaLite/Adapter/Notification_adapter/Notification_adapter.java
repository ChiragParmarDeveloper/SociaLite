...
import com.ap.SociaLite.Pojo.intrested;
...
public class Notification_adapter extends RecyclerView.Adapter<Notification_adapter.MyHolder> {
    ...
    List<data> datas;
    List<intrested> intresteds;
    data item;
    intrested item1;

    public Notification_adapter(Context mContext, Notification notification, List<data> datas, List<intrested> intresteds) {
        this.mContext = mContext;
        this.notification = notification;
        this.datas = datas;
        this.intresteds = intresteds;
    }
...
//        String array = Name.toString();
        ...
        //  String Type = datas.get(viewType).notification_type;datas.get()intresteds.get(viewType).notification_type;
